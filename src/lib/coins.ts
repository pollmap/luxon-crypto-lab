...
export const COINS: readonly CoinMeta[] = [
  {
    ...
    subIssues: [
      { slug: "bitcoin-21m-monetary-evolution", label: "#1-A", title: "비트코인은 왜 21,000,000개인가", publishedAt: "2026-06-01", scope: "도입 + 토크노믹스 + 화폐 진화 4단계" },
      { slug: "bitcoin-mining-etf", label: "#1-B", title: "4번의 반감기 후 마이너 경제학과 ETF", publishedAt: "2026-06-08", scope: "합의 (PoW·해시·마이너) + ETF $102B 흐름" },
      { slug: "bitcoin-macro-cycle", label: "#1-C", title: "DXY·금리·M2와 BTC — 매크로 회귀 vs NY Fed 반박", publishedAt: "2026-06-15", scope: "매크로 상관관계 + 학계 카운터 시각" },
      { slug: "bitcoin-nvt-mvrv-risk", label: "#1-D", title: "NVT·MVRV로 본 BTC 적정가 그리고 리스크", publishedAt: "2026-06-22", scope: "온체인 가치평가 + 양자/정치/집중도 리스크" },
      { slug: "bitcoin-satoshi-whitepaper", label: "#1-E", title: "사토시 백서 깊이 읽기 — P2P 전자현금의 9가지 원칙", publishedAt: "2026-06-29", scope: "백서 9개 섹션 분석 + cypherpunks 계보" },
      { slug: "bitcoin-l2-lightning-ordinals", label: "#1-F", title: "BTC L2 시대 — Lightning · Ordinals · Stacks · BOB", publishedAt: "2026-07-06", scope: "비트코인 위 생태계의 부활" },
      { slug: "bitcoin-self-custody-vs-etf", label: "#1-G", title: "Self-custody의 미래 — 콜드월렛 vs ETF 위탁", publishedAt: "2026-07-13", scope: "검열저항 정신 vs 기관 인프라 trade-off" },
      { slug: "bitcoin-mining-pool-geopolitics", label: "#1-H", title: "채굴 풀 집중도 — Foundry · AntPool · F2Pool 지정학", publishedAt: "2026-07-20", scope: "지역 편중 + 51% 공격 비용 + 정치 리스크" },
      { slug: "bitcoin-quantum-deep-dive", label: "#1-I", title: "Quantum 위협 깊이 분석 — Lattice 전환 시나리오", publishedAt: "2026-07-27", scope: "RSA 2048 / ECDSA 256 vs 양자 진척도" },
      { slug: "bitcoin-cycle-comparison-finale", label: "#1-J", title: "4번의 사이클 회고 + 5차 반감기 카운트다운 (시리즈 결론)", publishedAt: "2026-08-03", scope: "1-4차 사이클 비교 + 2028년 4월 17일 5차 반감기" },
    ],
  },
  {
    symbol: "ETH",
    ...
    subIssues: [
      { slug: "ethereum-pectra-anniversary", label: "#2-A", title: "Pectra 1주년 — ETH는 무엇인가", publishedAt: "2026-08-10", scope: "두 백서 비교 + Pectra 5 EIP + Fusaka 로드맵" },
      { slug: "ethereum-eip1559-deflation", label: "#2-B", title: "EIP-1559와 디플레이션 토크노믹스", publishedAt: "2026-08-17", scope: "Burn 메커니즘 + ETH 발행률 + Ultra Sound Money 가설" },
      { slug: "ethereum-pos-validators", label: "#2-C", title: "PoS 합의 — 100만 검증자 경제학", publishedAt: "2026-08-24", scope: "32 ETH 입장료 + 슬래싱 + 통합(EIP-7251) 효과" },
      { slug: "ethereum-lido-lst", label: "#2-D", title: "Lido stETH와 리퀴드 스테이킹 시스템 리스크", publishedAt: "2026-08-31", scope: "30% 도미넌스 · 분산화 우려 · DeFi 통합" },
      { slug: "ethereum-eigenlayer-restaking", label: "#2-E", title: "EigenLayer · Restaking과 AVS의 신탁 위임", publishedAt: "2026-09-07", scope: "Restaking 모델 · AVS 생태계 · 시스템 리스크 누적" },
      { slug: "ethereum-l2-value-leak", label: "#2-F", title: "L2 가치 누수 — Arbitrum / Base / Optimism", publishedAt: "2026-09-14", scope: "L2 fee 점유 · ETH 디플레이션 균형 · Fragmentation" },
      { slug: "ethereum-defi-tvl", label: "#2-G", title: "DeFi 생태계 — TVL $50B 인프라", publishedAt: "2026-09-21", scope: "Aave/Maker/Uniswap · Stablecoin · RWA on Ethereum" },
      { slug: "ethereum-macro-eth-btc-ratio", label: "#2-H", title: "매크로 — ETH/BTC ratio와 Fed 사이클", publishedAt: "2026-09-28", scope: "ETH/BTC 1년 추세 · 위험자산 베타 · 기관 ETF" },
      { slug: "ethereum-pf-ps-valuation", label: "#2-I", title: "P/F · P/S로 본 ETH 가치평가", publishedAt: "2026-10-05", scope: "Token Terminal · Burn-adjusted PE · Mike Ipolito 모델" },
      { slug: "ethereum-conclusion-ultra-sound-money", label: "#2-J", title: "Ultra Sound Money 가설 검증 · 시리즈 결론", publishedAt: "2026-10-12", scope: "10편 종합 · 가설 검증 · 다음 시리즈 예고" },
    ],
  },
  {
    symbol: "DOGE",
