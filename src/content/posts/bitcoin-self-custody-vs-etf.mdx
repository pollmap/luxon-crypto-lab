...
## 4. 결론 — 권장 portfolio 비율

종합 권장:

### 일반 투자자 (BTC 보유 1 BTC 이하)

- **100% ETF** 권장
- Self-custody 운영 학습 비용 > 검열저항 가치
- 401(k)/IRA 계정 활용

### 중간 투자자 (1-10 BTC)

- **70% Self-custody + 30% ETF**
- Self-custody = 하드웨어 월렛 (Ledger/Trezor)
- ETF = 트레이딩 노출 + 세제 통합

### 큰 보유자 (10 BTC 이상)

- **80% Self-custody (multisig) + 15% ETF + 5% 거래소**
- Multisig = Casa/Unchained Capital
- ETF = 상속 + 세제
- 거래소 = 단기 거래
