...
2008년 10월 31일, "Satoshi Nakamoto" 라는 익명 인물이 cypherpunks 메일링 리스트에 9페이지 PDF 를 올렸습니다. 그게 비트코인의 시작입니다. 본 편은 그 백서가 정확히 무엇을 풀려고 했고, 18년 후 무엇이 맞고 무엇이 빗나갔는지를 9가지 원칙으로 분석합니다. **사토시의 정체보다 백서의 9가지 원칙이 훨씬 더 중요합니다.**
</Callout>
...
이 한 문장이 18년 후 1조 5,740억 달러 자산으로 발전한 출발점입니다. 백서의 핵심을 5분에 정리할 수도 있지만, 그렇게 하면 **왜 이 백서가 그 전 20년의 cypherpunks 시도들과 달리 성공했는지**를 놓칩니다.
...
사토시 백서는 분명 천재적 종합 작품이지만, **새로 발명한 것은 거의 없습니다**. PoW = Hashcash (Adam Back, 1997), 분산 합의 = Lamport's Byzantine Generals (1982), 디지털 서명 = ECDSA (1992). **사토시의 진짜 기여는 발명이 아니라 통합** — 기존 cypherpunks 도구들을 한 작동 가능한 시스템으로 결합. 이 시각이 사토시 신화화의 카운터.
</Callout>
